...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LHFCocoapodsTest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lhf1078988033@126.com/LHFCocoapodsTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lhf1078988033@126.com' => 'lhf@elinklaw.com' }
  s.source           = { :git => 'https://github.com/lhf1078988033@126.com/LHFCocoapodsTest.git', :tag => s.version.to_s }
